...
export class ArtifactManager {
	 ...
	 */
	allocateId(): number {
		// Skip retired ids: a rollback that could not durably remove a published artifact retires its
		// ids so they can never be handed out again and collide with the leaked file.
